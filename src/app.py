...
def create():
    try:
        ...
        if persona.validarDni1(dni):
            ...
            persona.guardarPersona(dni,nombres,fecha,correo)
            return jsonify({'datos':'Persona guardada'})
    except Exception as e:
        return jsonify({'error': e})
    ...
    try:
        ...
        if file != None:
            ...
            if validar >=2:
                ...
                print(data)
                return jsonify({'datos':'Persona actualizada'})
        else:
            return jsonify({'datos': 'No existe ese dato con ese ID'})
    except Exception as e:
        return jsonify({'error': e})
...
def delete(id):
    try:
        ...
        if file != None:
            ...
            return jsonify({'datos':'Persona eliminada'})
        else:
            return jsonify({'datos': 'No existe ese dato con ese ID'})
    except Exception as e:
        return jsonify({'error': e})
